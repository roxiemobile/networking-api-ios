...
// MARK: - Functions
     ...
     * @link https://grepcode.com/file/repository.grepcode.com/java/root/jdk/openjdk/8-b132/java/net/CookieManager.java
     */
...
// MARK: - Private Functions
    ...
    fileprivate func pathMatches(_ path: String?, pathToMatchWith: String?) -> Bool {
        ...
        else if (path == nil) || (pathToMatchWith == nil) {
            return false
        }
        else if (path!.hasPrefix(pathToMatchWith!)) {
            return true
        }
